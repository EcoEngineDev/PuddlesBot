...
class PuddlesBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        try:
            ...
            print("Task commands: /task, /mytasks, /showtasks, /oldtasks, /alltasks, /tcw")
            print("Interactive messages: /intmsg, /imw")
            print("Fun commands: /dice, /8ball, /coinflip")
...
# Task UI classes moved to tasks.py module
...
# Task functions moved to tasks.py module

# Task commands moved to tasks.py module

# All task commands moved to tasks.py module
